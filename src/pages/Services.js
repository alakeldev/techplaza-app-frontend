                        ...
                        <Col md={6} order={2} className="d-flex justify-content-md-center align-items-md-center">
                            <Accordion defaultActiveKey="0" className={styles.ServicesAccordion}>
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header className={styles.AccordionHeader}>Community Applications</Accordion.Header>
                                    <Accordion.Body className={styles.AccordionBody}>
                                        As a registered user, enjoy free access to our suite of applications and games. These tools, including a weather app, task manager, and notes app, are designed to simplify your daily tasks and boost productivity. We’re always working to add more features to help make your life easier and more organized.
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="1">
                                    <Accordion.Header className={styles.AccordionHeader}>IT Support Service</Accordion.Header>
                                    <Accordion.Body className={styles.AccordionBody}>
                                ...
                                <Accordion.Item eventKey="2">
                                    <Accordion.Header className={styles.AccordionHeader}>Community Chat Service</Accordion.Header>
                                    <Accordion.Body className={styles.AccordionBody}>
